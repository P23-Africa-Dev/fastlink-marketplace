...
export function NotificationsInbox({
  ...
  return (
    <div className="space-y-6 max-w-3xl">
      <div className="flex items-center justify-between gap-4">
        ...
        {unreadCount > 0 && (
          <button
            ...
            className="text-xs font-bold text-[#7a3dbf] hover:underline disabled:opacity-60"
          >
            Mark all read
          </button>
        )}
      ...
      <div className="rounded-2xl border border-[#EBD7FA] bg-white divide-y divide-[#F5F1FA] shadow-sm">
        {isLoading && (
